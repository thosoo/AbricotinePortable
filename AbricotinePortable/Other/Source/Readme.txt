...
user in an INI file next to AbricotinePortable.exe called AbricotinePortable.ini.
...
copy AppNamePortable.ini from this directory to AbricotinePortable.ini next to
AbricotinePortable.exe. The options in the INI file are as follows:
